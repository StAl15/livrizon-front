...
export const KnowledgeItem: React.FC<Props> = ({card}) => {
    return (
        <>
            <div className={'group bg-white rounded-2xl w-56 h-auto p-5 grid justify-items-center my-auto mr-5 hover:shadow-2xl transition-all duration-1000'}>
                ...
                <div className={'mt-3 w-full hidden group-hover:grid transition-all duration-1000'}>
                    <button className={'w-full px-5 py-3 font-montserratRegular bg-blue rounded-2xl text-white mb-3'}>Изменить</button>
                    <button className={'w-full px-5 py-3 font-montserratRegular bg-red-500 rounded-2xl text-white'}>Удалить</button>
                </div>
            </div>
        </>
    );
